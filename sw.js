const CACHE_NAME='toxic-teddies-arrow-escape-v9';
const CORE_ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/backdrops/toxic-toby-expression-sheet.svg','./.nojekyll'];
