...
const CORE_ASSETS = [
  ...
  './index.html',
  './styles.css?v=37',
  './compiled-patterns.css?v=37',
  './hard-mode-v3.css?v=37',
  './src/design-system/tokens.css',
  './src/design-system/accessibility.css',
  './src/design-system/completion-feed.css',
  './src/design-system/loading-screen.css',
  './src/design-system/dark-theme-overrides.css',
